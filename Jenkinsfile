...
pipeline {
    ...
    stages {
        ...
        stage('Build Approval') {
            steps {
                script {
                    ...
                    def recipients = 'suryaanand456@gmail.com' // Add dynamic recipients here
        ...
        stage('Build and Push Docker Image') {
            ...
            steps {
                // Build Docker image
                sh 'docker build -t 9989228601/sample-project:17 .'
                ...
                withCredentials([usernamePassword(credentialsId: '377e98fd-7ba5-4b8f-a3a2-405f82ade900', usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                    ...
                    sh 'docker push 9989228601/sample-project:17'
                }
            }
        }
